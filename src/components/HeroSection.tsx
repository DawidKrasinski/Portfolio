        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 text-cyan-400">
              ...
              <span className="tracking-wider">{`{greeting or identifier}`}</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl">
              <span className="bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                {`{main headline explaining who the developer is and what they offer}`}
              </span>
            </h1>
            
            <p className="text-xl text-gray-400">
              {`{subheadline describing specialization in JavaScript/React/Next.js}`}
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 transition-all duration-300 rounded-lg flex items-center gap-2 shadow-lg shadow-cyan-500/50">
                {`{primary CTA encouraging contacting or hiring}`}
              ...
              <button className="px-8 py-4 border-2 border-cyan-500/50 hover:border-cyan-400 hover:bg-cyan-500/10 transition-all duration-300 rounded-lg">
                {`{secondary CTA leading to portfolio}`}
              </button>
            </div>
            ...
            <div className="flex gap-8 pt-8">
              <div>
                <div className="text-3xl text-cyan-400">{`{number}`}</div>
                <div className="text-gray-500">{`{metric label}`}</div>
              </div>
              <div>
                <div className="text-3xl text-purple-400">{`{number}`}</div>
                <div className="text-gray-500">{`{metric label}`}</div>
              </div>
              <div>
                <div className="text-3xl text-pink-400">{`{number}`}</div>
                <div className="text-gray-500">{`{metric label}`}</div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 font-mono text-sm">
                    <div className="flex gap-4">
                      ...
                      <span><span className="text-purple-400">const</span> <span className="text-cyan-400">{`{variableName}`}</span> <span className="text-pink-400">=</span> <span className="text-green-400">{`{value}`}</span></span>
                    </div>
                    <div className="flex gap-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <span><span className="text-purple-400">function</span> <span className="text-yellow-400">{`{functionName}`}</span><span className="text-gray-400">()</span> <span className="text-gray-400">{'{'}</span></span>
                    </div>
                    <div className="flex gap-4">
                      <span className="text-gray-600">4</span>
                      <span className="pl-4"><span className="text-purple-400">return</span> <span className="text-cyan-400">{`{value}`}</span></span>
                    </div>
                    <div className="flex gap-4">
